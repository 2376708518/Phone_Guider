...
![Last Commit](https://img.shields.io/github/last-commit/2376708518/Phone_Guider)
...
```bash
# 克隆项目
git clone https://github.com/2376708518/Phone_Guider.git
cd Phone_Guider
```

### 使用

#### 方式 1: 在 OpenClaw 对话中使用（推荐）

将项目复制到 OpenClaw skills 目录：

```bash
cp -r Phone_Guider ~/.openclaw/workspace/skills/
```
...
4. 编辑 `references/tb_config.json`，填入你的密钥
5. 测试连接：`node scripts/tb_api.js test`

详细指南：[docs/TAOBAO_API_GUIDE.md](docs/TAOBAO_API_GUIDE.md)
...
crontab -e
# 添加：
0 8 * * 0 cd /path/to/Phone_Guider && node scripts/weekly_update.js
```
...
- 项目地址：https://github.com/2376708518/Phone_Guider
- 问题反馈：https://github.com/2376708518/Phone_Guider/issues
